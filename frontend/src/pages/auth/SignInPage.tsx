...
const SignInPage: React.FC<SignInPageProps> = ({ onSwitchToSignUp, onSwitchToReset }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (formData.rememberMe) {
        localStorage.setItem('commcoach_remember', 'true');
      }
    } catch (error) {
      setErrors({ submit: error instanceof Error ? error.message : 'Sign in failed' });
    }
  };
