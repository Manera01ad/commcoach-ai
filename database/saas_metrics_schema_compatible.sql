...
-- =====================================================
-- This version works alongside your existing subscription_plans
-- and creates separate tables for SaaS metrics tracking

-- Enable UUID extension
CREATE EXTENSION IF NOT EXISTS "uuid-ossp";

-- =====================================================
-- OPTION 1: Keep Your Existing subscription_plans
-- Create new tables that reference it
-- =====================================================

-- 1. USER SUBSCRIPTIONS (references your existing subscription_plans)
...
-- Enable RLS on new tables (subscription_plans already has RLS)
...
-- =====================================================
-- VIEWS FOR ANALYTICS (Compatible with your schema)
-- =====================================================

-- View: Current MRR (uses your existing subscription_plans structure)
...
BEGIN
  ...
  RAISE NOTICE '📊 Tables created: 7 (using existing subscription_plans)';
  RAISE NOTICE '🔒 RLS policies enabled';
  RAISE NOTICE '📈 Analytics views created';
  RAISE NOTICE '🔗 Compatible with your existing subscription_plans table';
  RAISE NOTICE '🎯 Ready to use!';
  RAISE NOTICE '';
  RAISE NOTICE '📝 Your existing subscription_plans structure:';
  RAISE NOTICE '   - name, tier, stripe_price_id, price_usd';
  RAISE NOTICE '   - features, limits, is_active';
  RAISE NOTICE '';
